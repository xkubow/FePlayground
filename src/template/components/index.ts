...
import KDescriptions from './form/KDescriptions.vue';
import KDescriptionsItem from './form/KDescriptionsItem.vue';
import KDialog from './form/KDialog.vue';
import KPagination from './form/KPagination.vue';
import KPopconfirm from './form/KPopconfirm.vue';
import KPopover from './form/KPopover.vue';
import KStep from './form/KStep.vue';
import KSteps from './form/KSteps.vue';
...
export default {
  install: (app: App): App => {
    ...
    app.component('KDescriptions', KDescriptions);
    app.component('KDescriptionsItem', KDescriptionsItem);
    app.component('KPagination', KPagination);
    app.component('KPopconfirm', KPopconfirm);
    app.component('KPopover', KPopover);
    app.component('KStep', KStep);
    app.component('KSteps', KSteps);
