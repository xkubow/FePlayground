				...
				<el-form id="login-form" label-position="top">
					<el-form-item :label="t('loginName')" label-width="120px">
						<div class="el-input el-input--mini">
							<input id="login-name-input" :placeholder="t('loginName')" ref="loginName" v-model="name"
								type="text" autocomplete="off" autofocus class="el-input__inner" @keyup.enter="logIn"
								autocapitalize="off" spellcheck="false" autocorrect="off" />
						</div>
					</el-form-item>
					<el-form-item :label="t('password')" label-width="120px">
						<div class="el-input el-input--mini">
							<input :placeholder="t('password')" v-model="password" type="password" autocomplete="off"
								class="el-input__inner" @keyup.enter="logIn" />
						</div>
					</el-form-item>
