...
export class Page<TServerData, TLocalData, TProps, TTable extends Record<string, Table>> implements StateTree {
	...
	constructor(public name: string, serverData: TServerData, localData: TLocalData, props: TProps, tables: TTable) {
...
export class Entity<TServerData, TLocalData, TProps, TTable extends Record<string, Table>> {
	...
	constructor(public serverData: TServerData, public localData: TLocalData, public tables: TTable, public props: TProps) {}
}
