            ...
            <div>
              ...
              <k-row>
                <k-select
                  ...
                  v-model="prirazenaSkupinaUzivateluId"
                ...
                <k-select
                  ...
                  :options="uzivatelPrirazenoDropDownList"
                />
                <k-form-item v-bind="{ label: t('text') }" class="el-col-24 el-col-xs-24">
                  <k-rich-text
                    ...
                    v-bind="{
                      ...
                      baseUrl,
                      uploadVisible: false,
                      editable: vraceniBaterieStatusEnum !== EnumVraceniBaterieStatus.uzavreno,
                    }"
                  />
                </k-form-item>
              </k-row>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const kReseni = () => {
        mapedLast.vraceniBaterieStatusEnum.value = EnumVraceniBaterieStatus.vReseni;
        edit.save(mapedLast.id.value?.toString()!);
      };
      const uzavreni = () => {
        mapedLast.vraceniBaterieStatusEnum.value = EnumVraceniBaterieStatus.uzavreno;
        edit.save(mapedLast.id.value?.toString()!);
      };
      ...
      async function openEskalace() {
        if (pageManagerStore.previous?.name == 'VozidloEdit') await router.back();
        else await openEdit(VOZIDLO_NAME, PageMode.EDIT, { id: mapedLast.vozidloKnr.value! });
      }
