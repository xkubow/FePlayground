<template>
	<div class="action_envelop">
		...
		<k-button :disabled="!operationEskalaceCreate" @click="clickEvent('createEskalaci')">{{ t('createEskalaci')
			}}</k-button>
...
defineProps<Props>();
const emit = defineEmits(['update:modelValue', 'createZavadu', 'createEskalaci', 'openTestyUps', 'openPuvodniUps', 'openCarRfid', 'openPuvodniSqs', 'openElsa']);
